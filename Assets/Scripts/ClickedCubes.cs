...
// Debug.Log Example 2: Show selection of a clicked GameObject:
// https://docs.unity3d.com/2021.3/Documentation/ScriptReference/Debug.Log.html
...
public class ClickedCubes : MonoBehaviour
{
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                if (rend)
                {
                    ...
                    {
                        tempColor.a = 0.25F;
                        Debug.Log("GameObject made transparent");
                    }
                    else
                    {
                        tempColor.a = 1.00F;
                        Debug.Log("GameObject made opaque");
                    }
